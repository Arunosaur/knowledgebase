              ...
              for (const schema of schemas) {
                ...
                try {
                  ...
                  for (let i = 0; i < objRows.length; i++) {
                    ...
                    // Scan source if PACKAGE/PROCEDURE/FUNCTION
                  ...
                  // Scan dependencies
                  if (totalObjects > 0) {
                    const depSql = `SELECT NAME, TYPE, REFERENCED_OWNER, REFERENCED_NAME, REFERENCED_TYPE FROM DBA_DEPENDENCIES WHERE OWNER = '${schema}' FETCH FIRST 5000 ROWS ONLY`;
